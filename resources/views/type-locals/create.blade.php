...
@section('title', 'Ajouter un Type de Local')
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-6 mb-8 border border-green-100">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Ajouter un Type de Local</h1>
                    <p class="text-gray-600 mt-1">Créer une nouvelle catégorie d'espace</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-100">
            ...
            <form action="{{ route('type-locals.store') }}" method="POST" class="p-8">
                @csrf
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 border border-gray-200">
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
                            ...
                            <div class="ml-4">
                                <div class="text-sm font-semibold text-gray-900" id="preview-name">Nom du type</div>
...
document.getElementById('nom').addEventListener('input', function(e) {
    ...
    previewName.textContent = e.target.value || 'Nom du type';
});
</script>
@endsection
