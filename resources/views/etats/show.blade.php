            ...
            <div class="p-6">
                <div class="flex justify-between items-center mb-8">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            Gérez les informations et les affectations liées à cet état
                        </p>
                    </div>
                    <div class="flex space-x-4">
                        ...
                        <form action="{{ route('etats.destroy', $etat) }}" method="POST" class="inline">
                            ...
                            <button type="submit" 
                                    ...
                                    class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-lg transition-colors duration-150 ease-in-out focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <div class="bg-white dark:bg-gray-700 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-600">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ $etat->name }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-700 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-600">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Affectations</p>
                                <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ $etat->affectations_count ?? $etat->affectations()->count() }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-700 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-600">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Créé le</p>
                                <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ $etat->created_at->format('d/m/Y') }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-700 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-600">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ $etat->updated_at->format('d/m/Y') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-end mt-8">
                    <a href="{{ route('etats.index') }}"
                       class="inline-flex items-center px-4 py-2 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 text-sm font-medium rounded-lg transition-colors duration-150 ease-in-out">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
