            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl">
                <div class="p-8">
                    <div class="mb-8">
                        ...
                        <p class="mt-2 text-base text-gray-600">Update your email address. You'll need to confirm your current password for security.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('profile.updateEmail') }}" class="space-y-6">
                        ...
                        <div class="space-y-1">
                            <label for="email" class="block text-sm font-medium text-gray-90">New Email Address</label>
                        ...
                        <div class="space-y-1">
                            <label for="password" class="block text-sm font-medium text-gray-900">Current Password</label>
                            <div class="mt-1 relative rounded-md shadow-sm">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <div class="flex items-center justify-end gap-4 pt-4">
                            <a href="{{ route('profile.index') }}"
                                class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-lg font-medium text-sm text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-200">
                                Cancel
                            </a>
                            <button type="submit"
