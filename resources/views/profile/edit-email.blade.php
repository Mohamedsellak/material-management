    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="mb-6">
                        <h2 class="text-2xl font-semibold text-gray-800">Change Email Address</h2>
                        <p class="mt-1 text-sm text-gray-600">Update your email address. You'll need to confirm your current password.</p>
                    </div>
