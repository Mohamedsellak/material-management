                ...
                <div class="flex items-center space-x-6 pb-6 border-b">
                    <div class="shrink-0">
                        <img class="h-32 w-32 rounded-full object-cover border-4 border-gray-100 shadow-lg"
                             src="https://ui-avatars.com/material_management/public/api/?name={{ urlencode(session('user')->name) }}&background=0D8ABC&color=fff"
                             alt="Profile avatar">
                             {{-- <div class="flex justify-center items-center h-32 w-32 rounded-full border-4 border-gray-100 shadow-lg bg-purple-100">
