        ...
        <div class="max-w-4xl mx-auto">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-600 md:ml-2">Nouvelle entrée</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="mb-8 bg-gradient-to-r from-green-600 to-blue-600 rounded-xl p-6 text-white shadow-lg">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold">Nouvelle Entrée</h1>
                        <p class="text-green-100 mt-1">Enregistrer une nouvelle entrée de matériel en stock</p>
                    </div>
                </div>
            </div>

            <!-- Help Alert -->
            <div class="mb-8 bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 p-6 rounded-lg shadow-sm">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-blue-700 mt-1">Remplissez tous les champs requis pour enregistrer une nouvelle entrée de matériel. La quantité sera automatiquement ajoutée au stock existant.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <form action="{{ route('entrees.store') }}" method="POST" class="p-8">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="date" name="date" id="date" value="{{ old('date') }}"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 text-lg">
                            @error('date')
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" step="0.01" name="unit_price" id="unit_price" value="{{ old('unit_price') }}" min="0"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 text-lg"
                                   placeholder="0.00">
                            @error('unit_price')
                                <p class="text-red-600 text-sm mt-1 flex items-center">
