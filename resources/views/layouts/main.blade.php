            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden sm:flex sm:space-x-8">
                    ...
                    @if (session('user')->role == "admin")
                        ...
                        <div class="relative group">
                            ...
                            <div class="absolute left-0 mt-2 w-48 rounded-md shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                                <div class="py-1">
                                    ...
                                    <a href="{{ route('affectations.casse') }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                                        Casse
                                    </a>
                                </div>
                            </div>
                        ...
                        <a href="{{ route("reclamations.index") }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                            Reclamation
                        </a>          
                    @else
                        <a href="{{ route("fonctionnaire-reclamations.index") }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                            Reclamation
                        </a>
                    @endif
