            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('fournisseurs.show', $fournisseur) }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 transition-colors duration-200">{{ $fournisseur->name }}</a>
                    </div>
                </li>
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600">Modifiez les informations du fournisseur <span class="font-semibold">{{ $fournisseur->name }}</span></p>
                </div>
            ...
            <form action="{{ route('fournisseurs.update', $fournisseur) }}" method="POST" class="p-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <textarea name="adresse" id="adresse" rows="4"
                                  ...
                                  placeholder="Entrez l'adresse complète du fournisseur">{{ old('adresse', $fournisseur->adresse) }}</textarea>
                        @error('adresse')
                            <p class="mt-1 text-sm text-red-600 flex items-center">
                                <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                ...
                <div class="mt-6 pt-6 border-t border-gray-200">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 text-sm text-gray-600">
                        <div>
                            <span class="font-medium">Créé le:</span> {{ $fournisseur->created_at->format('d/m/Y à H:i') }}
                        </div>
                        <div>
                            <span class="font-medium">Dernière modification:</span> {{ $fournisseur->updated_at->format('d/m/Y à H:i') }}
                        </div>
                    </div>
                </div>
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-yellow-700">
                        <p>La modification des informations du fournisseur peut affecter les commandes et entrées existantes. Assurez-vous que les nouvelles informations sont correctes.</p>
                    </div>
                </div>
            </div>
        </div>
