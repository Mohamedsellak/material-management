            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p class="mt-1 text-gray-900 dark:text-gray-100">{{ $typeMaterial->name }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-gray-900 dark:text-gray-100">{{ $typeMaterial->created_at->format('d/m/Y') }}</p>
                    </div>
                </div>
