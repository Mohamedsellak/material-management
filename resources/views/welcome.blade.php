...
<body class="font-sans antialiased bg-gradient-to-br from-gray-50 to-gray-100">
    <!-- Navigation -->
    <nav class="bg-white/80 backdrop-blur-xl border-b border-gray-100 fixed w-full z-50">
    ...
    <div class="relative isolate pt-14">
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl text-center">
                    ...
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                        ...
                        <span class="block text-blue-600">FSDM Fès</span>
                    </h1>
        ...
        <div id="features" class="py-24 sm:py-32 backdrop-blur-xl relative overflow-hidden">
            ...
            <div class="absolute inset-0 bg-gradient-to-b from-blue-50/50 to-white/50"></div>
            <div class="absolute inset-y-0 right-1/2 -z-10 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] bg-white/80 shadow-xl shadow-blue-600/10 ring-1 ring-blue-50"></div>

            <div class="mx-auto max-w-7xl px-6 lg:px-8 relative">
                <!-- Enhanced Header Section -->
                <div class="mx-auto max-w-2xl lg:text-center mb-16">
                    <span class="inline-flex items-center rounded-full px-4 py-1 text-sm font-medium bg-blue-100 text-blue-600 ring-1 ring-inset ring-blue-600/20 mb-4">
                        <svg class="mr-2 h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                        </svg>
                        Fonctionnalités
                    </span>
                    <h2 class="mt-4 text-4xl font-bold tracking-tight bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent sm:text-5xl">
                ...
                <div class="mx-auto max-w-2xl lg:max-w-none">
                    <dl class="grid max-w-xl grid-cols-1 gap-x-12 gap-y-12 lg:max-w-none lg:grid-cols-3">
                        ...
                        <div class="relative group">
                            ...
                            <div class="relative p-8 backdrop-blur-xl rounded-xl border border-gray-200 hover:border-blue-500 transition-colors duration-300 h-full">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-sm font-medium text-blue-600">01</span>
                                </div>
                                <dt class="mt-6 text-xl font-semibold text-gray-900">
                        ...
                        <div class="relative group">
                            ...
                            <div class="relative p-8 backdrop-blur-xl rounded-xl border border-gray-200 hover:border-blue-500 transition-colors duration-300 h-full">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-sm font-medium text-blue-600">02</span>
                                </div>
                                <dt class="mt-6 text-xl font-semibold text-gray-900">
                        ...
                        <div class="relative group">
                            ...
                            <div class="relative p-8 backdrop-blur-xl rounded-xl border border-gray-200 hover:border-blue-500 transition-colors duration-300 h-full">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-sm font-medium text-blue-600">03</span>
                                </div>
                                <dt class="mt-6 text-xl font-semibold text-gray-900">
    ...
    <!-- Footer -->
    <footer class="bg-white/80 backdrop-blur-xl border-t border-gray-100">
        <div class="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
            <div class="flex justify-center space-x-6 md:order-2">
                <a href="https://www.fsdm.usmba.ac.ma/" class="text-gray-400 hover:text-blue-500">
                    Site FSDM
                </a>
            </div>
