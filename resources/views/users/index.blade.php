    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div class="flex-1 min-w-0">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h2 class="text-3xl font-bold leading-7 text-gray-900 sm:text-4xl sm:truncate">Users Management</h2>
        ...
        @if(session('success'))
            <div x-data="{ show: true }"
                ...
                class="rounded-lg bg-green-50 p-4 mb-6 border border-green-200">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div class="bg-green-100 rounded-lg p-1">
                    ...
                    <div class="ml-auto pl-3">
                        <div class="-mx-1.5 -my-1.5">
                            <button @click="show = false"
                                class="inline-flex rounded-md p-1.5 text-green-500 hover:bg-green-100 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-50 focus:ring-green-600">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    <div class="flex justify-center space-x-2">
                                        <a href="{{ route('users.show', $user->id) }}"
                                            class="group relative bg-blue-50 p-2 rounded-lg hover:bg-blue-100 transition-all duration-200">
                                        ...
                                        <a href="{{ route('users.edit', $user->id) }}"
                                            class="group relative bg-yellow-50 p-2 rounded-lg hover:bg-yellow-100 transition-all duration-200">
                                        ...
                                        <form action="{{ route('users.destroy', $user->id) }}" method="POST" class="inline">
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                class="group relative bg-red-50 p-2 rounded-lg hover:bg-red-100 transition-all duration-200"
